    ...
    <Box sx={{ display: 'flex', flexDirection: 'column', minHeight: '100vh', width: '100%' }}>
      ...
      <Box component="section" sx={{ py:8, bgcolor: 'background.paper' }}>
        <Container>
          ...
          南澳福建商会是一个服务澳大利亚福建籍企业家及乡亲的非营利性组织。我们的使命是通过为福建籍企业家提供教育，社会和信息服务，培育一个充满活力的商业社区。我们致力于通过为福建籍企业家提供更好的商业和国际贸易机会，推动闽商在澳大利亚的投资与发展，促进中澳经济的交流与合作。
          </Typography>
          <Typography variant="h6" maxWidth="800px" mx="auto" mt={5}>
          南澳福建商会愿与会员共同努力打造一个为闽商增进了解，交流与合作的平台，增强与中澳政府的合作，促进与全球其他商业组织的协作，帮助闽商在澳大利亚拓展业务。
          </Typography>
